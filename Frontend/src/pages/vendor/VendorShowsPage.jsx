          ...
          {filteredShows.map((show) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-4 sm:p-5 pl-5 sm:pl-6 flex flex-col lg:flex-row lg:items-center justify-between gap-5">
                  {/* =========================================================================
                      COLUMN 1: FILM POSTER & METADATA (Consistent width ~280px on desktop)
                      ========================================================================= */}
                  <div className="flex items-start gap-4 lg:w-[280px] xl:w-[320px] shrink-0 min-w-0">
                    {/* Movie Poster (2:3 Aspect Ratio) */}
                    <div className="relative w-20 sm:w-22 aspect-[2/3] rounded-xl overflow-hidden bg-slate-100 shrink-0 border border-slate-200/80 shadow-xs group-hover:scale-105 transition-transform duration-300">
                      <img
                        src={
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <h3 className="text-base sm:text-lg font-bold text-slate-900 leading-snug group-hover:text-[#F84464] transition-colors line-clamp-1 mt-1">
                        {show.movieTitle}
                      </h3>
                  ...
                  {/* =========================================================================
                      COLUMN 2: VENUE AUDITORIUM & SHOWTIME SLOT
                      ========================================================================= */}
                  <div className="lg:w-[220px] shrink-0 border-t lg:border-t-0 pt-3 lg:pt-0 border-slate-100">
                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-1.5">
                      Auditorium & Showtime
                    </p>

                    {/* Screen Badge */}
                    <div className="inline-flex items-center gap-1.5 bg-indigo-50 border border-indigo-100/80 px-2.5 py-1 rounded-lg text-indigo-900 font-bold text-xs mb-2">
                      <Tv size={13} className="text-indigo-600 shrink-0" />
                      <span className="truncate">{show.screen?.name || 'Screen 1'}</span>
                    </div>

                    {/* Showtime Box */}
                    <div className="flex items-center gap-2 bg-slate-50 border border-slate-200/70 p-2 rounded-xl text-xs">
                      ...
                      <span className="ml-auto text-[10px] font-bold bg-white px-2 py-0.5 rounded-md border border-slate-200 text-slate-700">
                        {show.showDate}
                      </span>
                    </div>
                  </div>
                  ...
                  {/* =========================================================================
                      COLUMN 3: AUDITORIUM CAPACITY & OCCUPANCY METER
                      ========================================================================= */}
                  <div className="lg:w-[230px] shrink-0 bg-slate-50/80 p-3 rounded-xl border border-slate-200/60">
                    ...
                    <div className="flex items-center justify-between text-[11px] mt-2">
                      ...
                      <span className="text-slate-500 font-mono text-[10px]">
                        ₹{estShowRevenue.toLocaleString('en-IN')} collected
                      </span>
                    </div>
                  </div>

                  {/* =========================================================================
                      COLUMN 4: TICKET PRICING BREAKDOWN TIERS
                      ========================================================================= */}
                  <div className="lg:w-[170px] shrink-0 border-t lg:border-t-0 pt-3 lg:pt-0 border-slate-100">
                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-1.5">
                      Ticket Tiers
                    </p>
                    <div className="space-y-1 text-xs">
                      <div className="flex items-center justify-between bg-slate-50 px-2 py-0.5 rounded border border-slate-100 text-[11px]">
                      ...
                      <div className="flex items-center justify-between bg-slate-50 px-2 py-0.5 rounded border border-slate-100 text-[11px]">
                        <span className="text-slate-500">Recliner</span>
                        <span className="font-mono font-bold text-slate-800">
                  ...
                  {/* =========================================================================
                      COLUMN 5: OPERATIONAL ACTION BUTTONS
                      ========================================================================= */}
                  <div className="flex lg:flex-col items-center lg:items-end justify-end gap-2 pt-3 lg:pt-0 border-t lg:border-t-0 border-slate-100 shrink-0">
                    <button
                      onClick={() => openSeatMapModal(show)}
                      className="inline-flex items-center justify-center gap-1.5 text-xs font-bold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200/80 px-4 py-2 rounded-xl transition shadow-2xs w-full sm:w-auto"
                    ...
                    {show.status !== 'cancelled' ? (
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-1 text-[11px] font-medium text-slate-400 hover:text-rose-600 hover:bg-rose-50 px-3 py-1.5 rounded-lg border border-transparent hover:border-rose-200 transition"
                      ...
                      <span className="text-[10px] font-bold text-rose-500 uppercase px-2 py-0.5">
                        Cancelled
                      </span>
                    )}
                  </div>
                ...
                {group.shows.map(show => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xs font-bold text-slate-800 truncate group-hover:text-[#F84464] transition">
                        {show.movieTitle}
                      </p>
