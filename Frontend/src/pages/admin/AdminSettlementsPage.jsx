  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5">
        <div className="bg-white border border-slate-100/90 rounded-2xl p-5 sm:p-6 shadow-[0_4px_24px_-4px_rgba(0,0,0,0.05),0_1px_3px_rgba(0,0,0,0.02)] hover:shadow-[0_18px_38px_-6px_rgba(0,0,0,0.09)] hover:border-slate-200 transition-all duration-300 relative overflow-hidden group">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400">
              Total Gateway Inflow
            </span>
            <div className="w-10 h-10 rounded-xl bg-slate-50 text-slate-700 border border-slate-100 flex items-center justify-center font-bold shadow-2xs group-hover:scale-105 transition-transform">
              <Landmark size={18} />
            </div>
          </div>
          ...
          <div className="mt-3 flex items-center gap-2 text-xs text-slate-500">
            <span className="bg-slate-50 text-slate-700 font-semibold px-2.5 py-0.5 rounded-full text-[10px] border border-slate-100">
              Gross Volume
            </span>
        ...
        <div className="bg-white border border-slate-100/90 rounded-2xl p-5 sm:p-6 shadow-[0_4px_24px_-4px_rgba(0,0,0,0.05),0_1px_3px_rgba(0,0,0,0.02)] hover:shadow-[0_18px_38px_-6px_rgba(0,0,0,0.09)] hover:border-slate-200 transition-all duration-300 relative overflow-hidden group">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="w-10 h-10 rounded-xl bg-slate-50 text-emerald-600 border border-slate-100 flex items-center justify-center font-bold shadow-2xs group-hover:scale-105 transition-all duration-300">
              <Percent size={18} />
            </div>
          </div>
          <div className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight font-sans">
        ...
        <div className="bg-white border border-slate-100/90 rounded-2xl p-5 sm:p-6 shadow-[0_4px_24px_-4px_rgba(0,0,0,0.05),0_1px_3px_rgba(0,0,0,0.02)] hover:shadow-[0_18px_38px_-6px_rgba(0,0,0,0.09)] hover:border-slate-200 transition-all duration-300 relative overflow-hidden group">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="w-10 h-10 rounded-xl bg-slate-50 text-blue-600 border border-slate-100 flex items-center justify-center font-bold shadow-2xs group-hover:scale-105 transition-all duration-300">
              <ShieldCheck size={18} />
            </div>
          </div>
          <div className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight font-sans">
