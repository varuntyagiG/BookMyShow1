                    ...
                    {searchInput ? (
                      ...
                      <>
                        <button
                          ...
                          className="px-2 py-0.5 rounded-md bg-gradient-to-r from-violet-600 to-[#F84464] hover:from-violet-500 hover:to-rose-500 text-white text-[10px] font-black tracking-wide flex items-center gap-1 cursor-pointer transition-all hover:scale-105 active:scale-95 shadow-sm"
