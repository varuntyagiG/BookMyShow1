      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full py-12 sm:py-16 lg:py-20">
        <div className="max-w-2xl lg:max-w-3xl space-y-4 sm:space-y-6 text-left">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 flex-wrap">
            <div className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/40 text-[11px] sm:text-xs font-bold uppercase tracking-wider backdrop-blur-md">
              <Star className="w-3.5 h-3.5 fill-amber-400 text-amber-400" />
              <span>★ 9.4/10 IMDb</span>
            </div>

            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 text-[11px] sm:text-xs font-bold uppercase tracking-wider backdrop-blur-md">
              <Tv className="w-3 h-3" />
              <span>IMAX 3D Laser</span>
            </span>
          </div>

          {/* Giant Cinematic Title (52–64px Desktop / 34–42px Mobile, Weight 800) */}
          <h1 className="text-[34px] sm:text-[44px] md:text-5xl lg:text-[62px] font-extrabold text-white tracking-tight leading-[1.08] drop-shadow-[0_10px_30px_rgba(0,0,0,0.9)]">
            {current.title}
          </h1>

          {/* Movie Spec Ribbon: Rating, Certificate & Languages (12–13px, Weight 500) */}
          <div className="flex items-center gap-3 text-xs sm:text-[13px] text-slate-300 flex-wrap font-medium">
            <span className="px-2 py-0.5 rounded-md bg-slate-800/80 border border-slate-700 text-slate-200 text-[11px] font-bold uppercase tracking-wide">
              UA 16+
            </span>
            <span>•</span>
          ...
          {/* Action Buttons Row (14–16px, Weight 700) */}
          <div className="pt-1 sm:pt-2 flex items-center gap-3 sm:gap-4 flex-wrap">
            <button
              type="button"
              onClick={handleBannerClick}
              className="bg-gradient-to-r from-[#F84464] via-[#ff4769] to-[#e03a58] hover:from-[#ff5274] hover:to-[#eb4363] text-white font-bold text-sm sm:text-base px-7 sm:px-9 py-3.5 sm:py-4 rounded-2xl transition-all shadow-[0_10px_30px_rgba(248,68,100,0.5)] hover:shadow-[0_15px_40px_rgba(248,68,100,0.7)] active:scale-95 flex items-center gap-2.5 cursor-pointer border border-white/20"
            >
